  ...
  expect_equal(results_QuiPT,
               structure(list(pval_thresholds = c(0.05, 0.01, 0.05, 0.01),
                              pval_adjustments = structure(c(1L,1L, 2L, 2L),
                                                           .Label = c("", "BH"),
                                                           class = "factor"),
                              accuracy_mean = c(0.828175386244405, 0.890648313038456, 0.901429465274101, 0.923039899889301),
                              ...
                              accuracy_std = c(NA_real_, NA_real_, NA_real_, NA_real_),
                              ...
                              recall_std = c(NA_real_, NA_real_, NA_real_, NA_real_)),
                         out.attrs = list(
                                dim = c(pval_thresholds = 2L, pval_adjustments = 2L),
                                dimnames = list(
                                  pval_thresholds = c("pval_thresholds=0.05", "pval_thresholds=0.01"), pval_adjustments = c("pval_adjustments=", "pval_adjustments=BH"))),
                         row.names = c(NA, -4L),
                         class = "data.frame",
...
test_that("FCBF benchmark", {
  ...
  expect_equal(results_FCBF,
               structure(list(accuracy_mean = 0.998411705250999, sensitivity_mean = 0.111111111111111,
                              specificity_mean = 0.999181078086613, F1score_mean = 0.108108108108108,
                              precision_mean = 0.105263157894737, recall_mean = 0.111111111111111,
                              accuracy_std = NA_real_, sensitivity_std = NA_real_, specificity_std = NA_real_,
                              F1score_std = NA_real_, precision_std = NA_real_, recall_std = NA_real_),
                         class = "data.frame", row.names = c(NA, -1L), setup = list(method = "FCBF")))
})
...
test_that("Chi-squared benchmark", {
  ...
  expect_equal(results_chi,
               structure(list(pval_thresholds = 0.1, pval_adjustments = structure(1L, .Label = "BH", class = "factor"),
                              accuracy_mean = 0.823843673292583, sensitivity_mean = 0.777777777777778,
                              specificity_mean = 0.823883616744545, F1score_mean = 0.00759219088937093,
                              precision_mean = 0.00381471389645777, recall_mean = 0.777777777777778,
                              accuracy_std = NA_real_, sensitivity_std = NA_real_, specificity_std = NA_real_,
                              F1score_std = NA_real_, precision_std = NA_real_, recall_std = NA_real_), out.attrs = list(
                                dim = c(pval_thresholds = 1L, pval_adjustments = 1L), dimnames = list(
                                  pval_thresholds = "pval_thresholds=0.1", pval_adjustments = "pval_adjustments=BH")),
                         row.names = c(NA, -1L), class = "data.frame", setup = list(method = "Chi-squared", pval_thresholds = 0.1, pval_adjustments = "BH")))
})
...
test_that("FSelectorRcpp benchmark", {
  ...
  expect_equal(results_fselector,
               structure(list(num_features = 519, top_fraction = 0.025, accuracy_mean = 0.976079318477162,
                              sensitivity_mean = 0.722222222222222, specificity_mean = 0.976299436389036,
                              F1score_mean = 0.0497131931166348, precision_mean = 0.0257425742574257,
                              recall_mean = 0.722222222222222, accuracy_std = NA_real_,
                         ...
                         setup = list(method = "gainratio", fraction = 0.025)))
})
...
test_that("MRMR benchmark", {
  ...
  expect_equal(results_MRMR,
               structure(list(accuracy_mean = 0.000866342590364345, sensitivity_mean = 1,
                              specificity_mean = 0, F1score_mean = 0.00173118538110123,
                              precision_mean = 0.000866342590364345, recall_mean = 1, accuracy_std = NA_real_,
                              sensitivity_std = NA_real_, specificity_std = NA_real_, F1score_std = NA_real_,
                              precision_std = NA_real_, recall_std = NA_real_),
                         class = "data.frame", row.names = c(NA, -1L), setup = list(method = "MRMR")))
})
