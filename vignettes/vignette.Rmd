...
* Various alphabet sizes are used:
  * Full 20-element alphabet with various probability vectors (based on drake repo)
  * Reduced alphabet (from literature and AmyloGram) with probabilites from AmyloGram analysis
