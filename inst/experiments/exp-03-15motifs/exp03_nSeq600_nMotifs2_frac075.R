...
plan <- drake_plan(
  ...
  output_prefix = "~/experiment-results/exp3_reduced_alph_enc_15motifs_amylogram_encoding/exp03-nSeq600-nMotifs2-frac075/result_",
...
cache <- new_cache("exp03_15motifs_nSeq600_nMotifs2_frac075")
make(
  plan,
  parallelism = "future",
  jobs = 8,
  log_make = "exp03_15motifs_nSeq600_nMotifs2_frac075.log",
  cache = cache,
  seed = 42
)
