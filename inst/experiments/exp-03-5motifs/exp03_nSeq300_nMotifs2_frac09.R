...
plan <- drake_plan(
  ...
  output_prefix = "~/experiment-results/exp3_reduced_alph_enc_5motifs_amylogram_encoding/exp03-nSeq300-nMotifs2-frac09/result_",
...
cache <- new_cache("exp03_5motifs_nSeq300_nMotifs2_frac09")
make(
  plan,
  parallelism = "future",
  jobs = 8,
  log_make = "exp03_5motifs_nSeq300_nMotifs2_frac09.log",
  cache = cache,
  seed = 42
)
