...
plan <- drake_plan(
  ...
  output_prefix = "~/experiment-results/exp3_reduced_alph_enc_5motifs_amylogram_encoding/exp03-nSeq600-nMotifs2-frac01/result_",
...
cache <- new_cache("exp03_5motifs_nSeq600_nMotifs2_frac01")
make(
  plan,
  parallelism = "future",
  jobs = 8,
  log_make = "exp03_5motifs_nSeq600_nMotifs2_frac01.log",
  cache = cache,
  seed = 42
)
