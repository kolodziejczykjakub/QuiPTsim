...
plan <- drake_plan(
  ...
  output_prefix = "~/experiment-results/exp01-seqLen10-nSeq600-frac075-amylogram-encoding/result_",
...
cache <- new_cache("exp01_seqLen10_nSeq600_frac075_amylogram_encoding")
make(
  plan,
  parallelism = "future",
  jobs = 8,
  log_make = "exp01_seqLen10_nSeq600_frac075_amylogram_encoding.log",
  cache = cache,
  seed = 42
)
