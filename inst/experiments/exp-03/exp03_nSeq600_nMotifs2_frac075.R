...
plan <- drake_plan(
  ...
  output_prefix = "~/experiment-results/exp03-nSeq600-nMotifs2-frac075/result_",
...
cache <- new_cache("exp03_nSeq600_nMotifs2_frac075")
make(
  plan,
  parallelism = "future",
  jobs = 8,
  log_make = "exp03_nSeq600_nMotifs2_frac075.log",
  cache = cache,
  seed = 42
)
