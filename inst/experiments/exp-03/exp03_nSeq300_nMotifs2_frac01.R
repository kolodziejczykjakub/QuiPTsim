...
plan <- drake_plan(
  ...
  output_prefix = "~/experiment-results/exp03-nSeq300-nMotifs2-frac01/result_",
...
cache <- new_cache("exp03_nSeq300_nMotifs2_frac01")
make(
  plan,
  parallelism = "future",
  jobs = 8,
  log_make = "exp03_nSeq300_nMotifs2_frac01.log",
  cache = cache,
  seed = 42
)
