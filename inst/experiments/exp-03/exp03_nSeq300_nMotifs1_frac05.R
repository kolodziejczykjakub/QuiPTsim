...
plan <- drake_plan(
  ...
  output_prefix = "~/experiment-results/exp03-nSeq300-nMotifs1-frac05/result_",
...
cache <- new_cache("exp03_nSeq300_nMotifs1_frac05")
make(
  plan,
  parallelism = "future",
  jobs = 8,
  log_make = "exp03_nSeq300_nMotifs1_frac05.log",
  cache = cache,
  seed = 42
)
